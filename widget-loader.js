(function() {
  ...
  if (existingViewport) {
    ...
    if (content && !content.includes('maximum-scale')) {
      existingViewport.setAttribute('content', content + ', maximum-scale=1.0');
    }
  }
  ...
  window._nbShowChat = function(type) {
    ...
    if (chat) { chat.style.display = 'flex'; chat.style.flex = '1'; chat.style.flexDirection = 'column'; chat.style.overflow = 'hidden'; chat.classList.add('nb-visible'); }
  ...
  window._nbShowHome = function() {
    var home = document.getElementById('nb-home-screen');
    var chat = document.getElementById('nb-chat-screen');
    if (home) { home.style.display = 'flex'; home.style.flex = '1'; }
    if (chat) { chat.style.display = 'none'; chat.style.flex = ''; chat.classList.remove('nb-visible'); }
